...
import { TRANSACTION_PAYMENT_METHOD_OPTIONS, TRANSACTION_TYPE_OPTIONS } from "../_constants/transactions"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <MoneyInput className="rounded-xl" placeholder="R$ 0.000,00" {...field} />
                  </FormControl>
                </FormItem>
              )}
            />
